...
export default function Home() {
  ...
  return (
    <>
      {/* Three.js Canvas - z-index: 2 (middle layer) */}
      ...
      <div className="content-container">
        ...
        <section className="intro-section" id="intro">
          ...
          {/* BACK LAYER - Role text (z-index: 1 - BEHIND model) */}
          <div className="intro-back-layer">
            <h1 className="role-text">
              {/* replace */}
            </h1>
          </div>
          
          {/* FRONT LAYER - Name & description (z-index: 3 - ABOVE model) */}
          <div className="intro-front-layer">
            <p className="greeting">Hi, I am</p>
            <h2 className="name-text">
              Gaurav <span className="highlight">Sidana</span>
            </h2>
            <p className="intro-description">
              Full Stack Developer with 2+ years of experience engineering scalable 
              backend solutions and web applications. Currently pursuing a Master's 
              in CS at Glasgow, I focus on optimizing distributed pipelines and 
              building high-impact software at scale.
            </p>
            <div className="intro-actions">
              <a 
                href="https://www.linkedin.com/in/gaurav-sidana-7a5118242" 
                target="_blank" 
              ...
              <a 
                href="https://github.com/gauravsidana241" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="social-btn"
              >
          ...
          {/* Stats on the left side (z-index: 3 - ABOVE model) */}
        ...
        {/* REST OF PAGE - All z-index: 3+ (ABOVE model) */}
