...
export default function ProjectScroller({ projects, isMobile = false }: ProjectScrollerProps) {
      ...
      <div className="project-dropdown">
        ...
        <div className="dropdown-list">
          {(projects || []).map((project) => (
            <div 
              key={project.id} 
              className={`dropdown-item ${expandedId === project.id ? 'expanded' : ''}`}
            >
              <div 
